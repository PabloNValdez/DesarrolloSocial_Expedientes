<template>
    <div class="mb-16 pb-10">
      <titulo class="pb-3" texto="Historial del Expediente N°" 
      :nro="this.get_historial[0].nro_expediente" 
            ...
            >
              ...
              >
                ...
                <v-card-text class="white text--primary">
                  ...
                  <p>{{item.hora}}</p>
                  <div class="Montserrat-Bold pb-2"> 
                    <!-- <a :href="process.env.VUE_APP_API_URL"> ... </a> -->
                  </div>
                  <!-- <v-row no-gutters justify="center" class="py-4">
                    ...
                    <v-col cols="12" lg="6" class="px-sm-2 py-5">
                      <Button link="/" texto="Aceptar" icono="mdi-check-bold" />
                    </v-col>
                  </v-row> -->
                </v-card-text>
