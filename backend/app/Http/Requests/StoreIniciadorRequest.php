...
class StoreIniciadorRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'cuit'              => 'unique:iniciadores,cuit|integer|digits_between:8, 11',
            'cuil'              => 'unique:iniciadores,cuil|integer|digits_between:11, 11|nullable',
            'telefono'          => 'integer|digits_between:7, 15|nullable',
            'email'             => 'max:255|email|nullable',
            'direccion'         => 'max:250|string|nullable',
        ];
    }
    ...
    public function messages()
    {
        return [
            ...
            'cuit.unique'              => 'Ya existe cuit.',
            'cuil.unique'              => 'ya existe cuil.',
            ...
            'direccion.max'             => 'Máximo 250 caracteres.'
        ];
    }
}
